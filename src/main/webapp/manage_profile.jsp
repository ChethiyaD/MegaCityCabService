...
<head>
    ...
    <script>
        window.onload = function() {
            ...
            console.log("URL Params - Success:", success, "Error:", error); // Log parameters

            if (success || error) {
                console.log("Displaying message:", success || error); // Log message display
                ...
                console.log("No success or error parameter found in URL."); // Log if no parameter
            }
        };
    </script>
</head>
...
<main>
    <div class="container">
        ...
        <form action="UpdateProfileServlet" method="post" enctype="multipart/form-data">
            <!-- Add hidden field to pass the username -->
            <input type="hidden" name="username" value="<%= user.getUsername() %>" />

            <p><strong>Name:</strong><br>
                <input type="text" name="name" value="<%= user.getName() %>" required></p>

            <p><strong>Phone:</strong><br>
                <input type="text" name="phone" value="<%= user.getPhone() %>" required></p>

            <p><strong>NIC:</strong><br>
                <input type="text" name="nic" value="<%= user.getNic() %>" required></p>

            <p><strong>Address:</strong><br>
                <input type="text" name="address" value="<%= user.getAddress() %>" required></p>
