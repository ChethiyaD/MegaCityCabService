...
<%
    ...
    List<User> drivers = userDAO.getAllDrivers(); // Changed to get all drivers
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script> <!-- Corrected URL -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> <!-- Corrected URL -->
    ...
    <script>
        function openEditModal(username, name, phone, nic, address, experience, status, profilePicture) {
            document.getElementById("editModalTitle").innerText = username ? "Edit Driver" : "Add Driver";
            ...
            document.getElementById("editExperience").value = experience || 0;
            ...
            document.getElementById("editForm").action = username ? "EditDriverServlet" : "AddDriverServlet"; // Adjusted for drivers
        ...
        function searchDrivers() {
            ...
            rows.forEach(row => {
                ...
                if (username.includes(input) || name.includes(input) || phone.includes(input) || nic.includes(input) ||
                    address.includes(input) || experience.includes(input) || status.includes(input)) {
                    row.style.display = "";
                } else {
...
<main>
    <div class="container">
        <input type="text" id="searchInput" class="form-control mb-3"
               placeholder="Search by Username, Name, Phone, NIC, Address, Experience, or Status" onkeyup="searchDrivers()">

        <button type="button" class="btn btn-primary" onclick="openEditModal('', '', '', '', '', 0, 'Available', 'default.png')">
            Add Driver
        </button>
        ...
        <table border="1" class="mt-3" id="driversTable">
            ...
            <tr>
                ...
                <td><%= driver.getNic() != null ? driver.getNic() : "Not Set" %></td>
                ...
                <td class="action-buttons">
                    <button class="btn btn-warning btn-sm" onclick="openEditModal(
                            ...
                            '<%= driver.getName() %>',
                            '<%= driver.getPhone() %>',
                            '<%= driver.getNic() != null ? driver.getNic() : "" %>',
